...
categories: [intermedaite, data vis]
image: horst-sf.png
---

> Handling spatial data can be tricky. The `sf` package allow for integration of R spatial software with the tidyverse if desired.
